...
//    if (inputData.size() > 2) {
//        if (inputData[0] == 0xFF and inputData[1] == 0xD8 and inputData[2] == 0xFF) {
...
//    }
//    
//    bool next(const T &data, T &min)
//    {
//        bool check = false;
//        return nextInternal(root, data, min, check);
//    }
//    
//    bool prev(const T &data, T &max)
//    {
//        bool check = false;
//        return prevInternal(root, data, max, check);
//    }
//    
//    
//    
...
//            T min;
//            if (right->height <= left->height) {
//                newNode->left = findAndRemoveMax(left, min); //если дерево классическое, в данной реализации c отзеркаленным деревом надо искать Min
//                newNode->right = right;
//            }
//            else
//            {
//                newNode->right = findAndRemoveMin(right, min);
//                newNode->left = left;
//            }
//            
//            return doBalance(newNode);
...
//    }
//    
//    bool nextInternal(Node *node, const T &data, T &min, bool &check) {
//        if (!node) {
//            return check;
//        }
//        
...
//            min = node->data;
//            check = true;
//            nextInternal(node->left, data, min, check);
//        } 
//        else {
//            nextInternal(node->right, data, min, check);
//        }
//        
//        return check;
//    }
//
//    bool prevInternal(Node *node, const T &data, T &max, bool &check) {
//        if (!node) {
//            return check;
//        }
//        
...
//            max = node->data;
//            check = true;
//            prevInternal(node->right, data, max, check);
//        } 
//        else {
//            prevInternal(node->left, data, max, check);
//        }
//        
//        return check;
//    }
...
//        }
//        else if (s == "exists") {
//            cout << tree.Has(node) << endl;
//        }
//        else if (s == "next") {
//            int min;
//            if (tree.next(node, min)) {
//                cout << min << endl;
//            }
//            else {
//                cout << "none" << endl;
